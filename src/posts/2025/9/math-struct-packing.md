...
<title>A visualization of the size computation described above, where Foo happens to start an unusual alignment. Two instances of Foo are laid side by side, with the first instance of Foo starting at memory address 2.</title>
