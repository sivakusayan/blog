...
<nav class="toc">
        <ol><li><a href="#foreword">Foreword</a></li><li><a href="#what-is-assistive-technology">What is assistive technology?</a><ol><li><a href="#what-is-a-screen-reader">What is a screen reader?</a></li><li><a href="#what-is-voice-recognition-software">What is voice recognition software?</a></li><li><a href="#what-information-does-assistive-technology-need-to-gather">What information does assistive technology need to gather?</a></li></ol></li><li><a href="#what-is-the-accessibility-api">What is the accessibility API?</a><ol><li><a href="#what-does-an-accessibility-tree-look-like">What does an accessibility tree look like?</a></li><li><a href="#how-can-i-view-the-accessibility-tree">How can I view the accessibility tree?</a></li></ol></li><li><a href="#what-technologies-use-the-accessibility-api">What technologies use the accessibility API?</a><ol><li><a href="#onscreen-keyboard">Onscreen Keyboard</a></li><li><a href="#windows-magnifier">Windows Magnifier</a></li><li><a href="#power-automate">Power Automate</a></li><li><a href="#grammarly">Grammarly</a></li><li><a href="#mobile-password-managers">Mobile Password Managers</a></li></ol></li><li><a href="#how-does-the-browser-generate-the-accessibility-tree">How does the browser generate the accessibility tree?</a><ol><li><a href="#generating-the-name">Generating the name</a></li><li><a href="#generating-the-role">Generating the role</a></li></ol></li><li><a href="#wrapup">Wrapup</a></li></ol>
      </nav>
</div>
</details>
